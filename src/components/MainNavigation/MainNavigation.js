                ...
                <ul className={classes['main-links']}>
                    <li className={classes['main-links__link']}>
                        <svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M7 21V11H13V21" stroke="#2B3844" stroke-width="1.8" stroke-linecap="round"
                    ...
                    <li className={classes['main-links__link']}><NavLink to='/sales-statistics'>
                        <svg width="18" height="22" viewBox="0 0 18 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                ...
                                stroke="#2B3844" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M11 1V7H17" stroke="#2B3844" stroke-width="1.8" stroke-linecap="round"
                                  stroke-linejoin="round"/>
                            <path d="M13 12H5" stroke="#2B3844" stroke-width="1.8" stroke-linecap="round"
                                  stroke-linejoin="round"/>
                            <path d="M13 16H5" stroke="#2B3844" stroke-width="1.8" stroke-linecap="round"
                                  stroke-linejoin="round"/>
                            <path d="M7 8H6H5" stroke="#2B3844" stroke-width="1.8" stroke-linecap="round"
                                  stroke-linejoin="round"/>
                        </svg>
                        My products
                    </NavLink>
